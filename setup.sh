...
eval "az synapse notebook import --workspace-name $synapse_workspace --name Insights_pre-processing --spark-pool-name spark3p2sm --file @$this_file_path/notebook/Insights_pre-processing.ipynb --only-show-errors"
eval "az synapse notebook import --workspace-name $synapse_workspace --name Insights_ingest --spark-pool-name spark3p2sm --file @$this_file_path/notebook/Insights_ingest.ipynb --only-show-errors"
